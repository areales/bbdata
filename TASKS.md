...
**As of 2026-08-29: 2 P1-series items pending (P1.8, P1.13); the other 12 fixed this session (unreleased — see "Unreleased" section).**
...
5. **Zero-row failures on the course's own printed examples — P1.8, P1.9, ~~P1.12~~.**
   ...
   **P1.12 and P1.9 fixed 2026-08-29 (unreleased)** — stat aliases + actionable
   errors for P1.12; a real multi-season fetch and comparison for P1.9. P1.8
   remains open.
