...
**As of 2026-08-29: 14 P1 items pending, none shipped since v0.10.0 (2026-04-21).**
The P1 wave is four months of facts-gate findings that were filed but never worked.
...
1. **The percent-formatting family — P1.4, P1.5, P1.6.** `fmtPercent` is
...
2. **Wrong quantity, not wrong scale — P1.10, P1.17.** `leaderboard-comparison`
   ...
   one transform.
3. **Fabricated and mislabeled values — P1.11, P1.16.** `savant-csv` zero-fills
