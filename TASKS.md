...
**As of 2026-08-29: 3 P1-series items pending (P1.8, P1.9, P1.13); the other 11 fixed this session (unreleased — see "Unreleased" section).**
...
5. **Zero-row failures on the course's own printed examples — P1.8, P1.9, ~~P1.12~~.**
   ...
   **P1.12 fixed 2026-08-29 (unreleased)** — course-vocabulary stat aliases +
   an actionable stat-not-found error; P1.8 and P1.9 remain open.
